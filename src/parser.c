...
enum {
  ...
  anon_sym_x86_64_sysvcc = 277,
  anon_sym_x86_fastcallcc = 278,
  anon_sym_x86_stdcallcc = 279,
  anon_sym_x86_thiscallcc = 280,
  anon_sym_zeroext = 281,
  sym_number = 282,
  aux_sym_float_token1 = 283,
  aux_sym_float_token2 = 284,
  anon_sym_true = 285,
  anon_sym_false = 286,
  anon_sym_zeroinitializer = 287,
  anon_sym_undef = 288,
  anon_sym_null = 289,
  anon_sym_none = 290,
  anon_sym_poison = 291,
  ...
  sym_string = 294,
  sym_label = 295,
  aux_sym_identifier_token1 = 296,
  aux_sym_identifier_token2 = 297,
  aux_sym_identifier_token3 = 298,
  aux_sym_identifier_token4 = 299,
  aux_sym_identifier_token5 = 300,
  aux_sym_identifier_token6 = 301,
  aux_sym_identifier_token7 = 302,
  aux_sym_identifier_token8 = 303,
  anon_sym_COMMA = 304,
  anon_sym_BANG = 305,
  anon_sym_EQ = 306,
  anon_sym_STAR = 307,
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == '$' ||
          ...
          lookahead == '_' ||
          ('k' <= lookahead && lookahead <= 'y')) ADVANCE(1271);
      END_STATE();
    case 1:
    ...
    case 88:
      ...
      if (lookahead == '$' ||
          ...
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('c' <= lookahead && lookahead <= 'z')) ADVANCE(1271);
      END_STATE();
    case 89:
      if (lookahead == ':') ADVANCE(1575);
    ...
    case 146:
      ...
      if (lookahead == '$' ||
          ...
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('e' <= lookahead && lookahead <= 'z')) ADVANCE(1271);
      END_STATE();
    case 147:
      if (lookahead == ':') ADVANCE(1575);
    ...
    case 1267:
      ...
      if (lookahead == '$' ||
          lookahead == '-' ||
          lookahead == '.' ||
          ('0' <= lookahead && lookahead <= '9')) ADVANCE(1271);
